...
// Deliberately plain, same reasoning as leadership/media and every other
// functional page this project. See docs/INTERFACE.md, on hold.
...
export function HodMediaClient({
  orgId,
  department,
  employeeCode,
  employeeName,
  ...
  async function handleUpload(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (insertErr) {
      // Same orphan-file gap already noted on leadership/media: the file is
      // in storage but has no row, not cleaned up automatically.
