// apps/ngo/src/app/(app)/hod/projects/HodProjectsClient.tsx
'use client';

// Deliberately identical body to LeadershipProjectsClient — see page.tsx's
// comment for why this page isn't department-filtered. Kept as its own
// file rather than imported cross-route, matching how every other pair of
// near-identical pages in this project (staff/dashboard vs staff/tasks,
// leadership vs hod tasks/media elsewhere in this same batch) each own
// their client component rather than reaching into another route's folder.
// Only real difference from the leadership version: usePageTitle('Projects')
// to match this page's own NAVMAP label.
...
export function HodProjectsClient({
  orgId,
  project,
  initialMilestones,
}: {
