...
// Deliberately plain, same reasoning as Compose Report and every other
...
export function HodSubmitClient({
  orgId,
  department,
  employeeCode,
  employeeName,
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Best-effort, same reasoning as Tasks' event log: the report write
    // already succeeded and is what matters, a failed event log doesn't
    // undo it.
